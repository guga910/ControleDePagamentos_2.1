...
//			boletos.add(new Boleto(descricao, valor, data2, indice));
	...
	public static void imprimirLista(List<Boleto> boletos) {
		...
		for (Boleto b : boletos) {
			...
			Boolean passouMesVencimento= b.getVencimento().getMonth()> LocalDate.now().getDayOfMonth();
			Boolean passouDiaVencimento= b.getVencimento().getMonth()>=  LocalDate.now().getMonthValue();
