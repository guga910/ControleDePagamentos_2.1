package controleDePagamentos.springBoot.controleDePagamentos2_1.vizualizacao;
...
import controleDePagamentos.springBoot.controleDePagamentos2_1.service.AtualizarBoletos;
import controleDePagamentos.springBoot.controleDePagamentos2_1.service.Vizualizar;
...
public class Visual {
	...
	public void aplicacao() throws SQLException {
		...
		while (!sair) {
			...
			System.out.println((opcao++) + " - Outras Op��es:");
			opcao = 0;
